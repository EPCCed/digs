/***********************************************************************
*
*   Filename:   disable-qcdgrid-node.c
*
*   Authors:    James Perry            (jamesp)   EPCC.
*
*   Purpose:    Implementation of command line utility to disable a node
*               on the QCDgrid
*
...
*    
*   Main entry point of disable-qcdgrid-node executable. Sets everything
*   up, then sends a message to the main node
*    
*   Parameters:                                [I/O]
*
*    argv[1]  FQDN of node to disable           I
*    
