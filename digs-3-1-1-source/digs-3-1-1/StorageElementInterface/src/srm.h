 ...
 ***********************************************************************/
digs_error_code_t digs_getLength_srm(char *errorMessage, const char *filePath,
...
void digs_free_string_srm(char **string) ;
/***********************************************************************
 *  digs_error_code_t digs_getOwner_srm(char *errorMessage, const char 
...
// ***********************************************************************/
//void digs_getList_srm(struct digs_result_t *result,
...
/***********************************************************************
 *digs_error_code_t digs_monitorTransfer_srm (char *errorMessage, int handle,
...
/***********************************************************************
 * digs_error_code_t digs_mkdir_srm(char *errorMessage, const char *hostname,
		const char *filePath);
 * 
...
/***********************************************************************
 * digs_error_code_t digs_rmdir_srm(char *errorMessage, const char *hostname, 
 * const char *filePath);
 * 
 ...
 ***********************************************************************/
digs_error_code_t digs_housekeeping_srm(char *errorMessage, char *hostname);
